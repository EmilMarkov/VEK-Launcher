...
export const SvgIconNotification: React.FC<Props> = ({size, color})=>{
    const { colors } = useContext(ThemeContext)
    var iconColor = colors.appIconColor
    if(color) iconColor = color
...
export const SvgIconFolder: React.FC<Props> = ({size, color})=>{
    const { colors } = useContext(ThemeContext)
    var iconColor = colors.appIconColor
    if(color) iconColor = color

    return(
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={iconColor} viewBox="0 0 18 18">
...
export const SvgIconLogo: React.FC<Props> = ({size, color})=>{
    const { colors } = useContext(ThemeContext)
    var iconColor = colors.appIconColor
    if(color) iconColor = color

    return(
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={iconColor} viewBox="0 0 16 20">
...
export const SvgIconCatalog: React.FC<Props> = ({size, color})=>{
    const { colors } = useContext(ThemeContext)
    var iconColor = colors.appIconColor
    if(color) iconColor = color
...
export const SvgIconLibrary: React.FC<Props> = ({size, color})=>{
    const { colors } = useContext(ThemeContext)
    var iconColor = colors.appIconColor
    if(color) iconColor = color
